...
/* function clear()
{
    ...
    document.getElementById("publicIdentity").value="";
    document.getElementById("privateIdentity").value="";
    ...
    document.getElementById("displayName-error").value="";
    document.getElementById("publicIdentity-error").value="";
    document.getElementById("privateIdentity-error").value="";
    document.getElementById("password-error").value="";
    document.getElementById("realm-error").value="";
    document.getElementById("secretQuestion-error").value="";
    document.getElementById("secretAnswer-error").value="";
	} */
</script>
...
<body style="background-image:/DhirendraNath/WebContent/images/Background-5.jpg ">
	...
	<!-- end top-bar -->
		...
		<p>	<img src="images/TCSLogo.jpg">&nbsp;Unified Communicator</p><%-- <a href="<%=request.getContextPath() %>/Controller?action=logout"><font color="#ffffff">Logout</font></a> --%>
	...
	<!-- MAIN CONTENT -->
	<div id="content">
<div id="errordiv1" style="color: green; font-size: 14px; margin-left: 35%;"><%if(request.getAttribute("messageToLogin")!=null) {%><%=request.getAttribute("messageToLogin").toString()%> <%} %></div>
		...
		<div id="register-content" class="register-class">
			<table>
				<tr>
					...
					<td><input type="text" id="displayName" name="displayName" placeholder="Your name" class="round full-width-input" onblur="display();"/></td>
					<td><span class="red-field" id="displayName-error"></span></td>
				</tr>
				<tr>
					<td><label class="forget-class">Public Identity</label></td>
					<td><input type="text" id="publicIdentity" name="publicIdentity" placeholder="Your name" class="round full-width-input"/></td>
					<td><span class="red-field" id="publicIdentity-error"></span></td>
				</tr>
				<tr>
					<td><label class="forget-class">Private Identity</label></td> 
					<td><input type="text" id="privateIdentity" name="privateIdentity" placeholder="eg- sip:name@tcs.com" class="round full-width-input"/></td>
				...
				<tr>
					...
					<td><input type="text" id="realm" name="realm" placeholder="tcs.com" class="round full-width-input"/></td>
				...
				<tr>
				<td><input type="reset" name="reset" value="Reset" class="reset-button" style="width:60%; margin-left:5%" onClick="window.location.reload()"></td>
