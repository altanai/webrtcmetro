...
/*          htmlcontenet2=' <input type='text' name='name' id='name' value='+response[0].name+' /> '; 
       ...
       /*   function endCall()//ADD These to the original hangup javascript
        	...
        	if(xmlHttpRequest.readyState==4&&xmlHttpRequest.status==200)
        		{
	        		...
	        		if(xmlHttpRequest.responseText.match('sip:') ){
	        			...
	        			var sipuri=xmlHttpRequest.responseText;
	        			document.write('<input type="button" onclick="dofriendadd('+sipuri+');" value ="Add the friend to Friendlist">');
        ...
        { alert("hello");
            ...
            xmlHttp.open("POST","Controller?action=addfbfriend&friendName="+frinedtobeadded, true);     
            xmlHttp.send(); 
