        ...
        <section style="margin-top:10px;">        	
                ...
                <input type="text" id="session-name" placeholder="Create Conference Room" style="height:45px;text-align:center; margin-left:15px;margin-right:15px;margin-down:47px;">                	
                 <div style="float: right;width:290px;">	
	        		...
	        		<div style="float: right;width:290px;" id="frndDiv">
				    <table border="1" style="max-height:150px;overflow:auto;width:100%;" id="frndTable">		   
				     <%if(friendList!=null){	    	
					...
					<div style="float: right;width:290px;height:40px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="progressBar" style="display:none;width:300px;margin:5px;padding:2px;background-color:white;border:1px solid black;text-align:center">
                            	<div style="width:0px;height:15px;background-color:green;" id="indicator"></div>
                            </div>
           ...
           <!-- Messaging ends -->  
            ...
            var connection = new RTCMultiConnection();
                ...
                connection.onFileProgress = function(packets, uuid) {
                    ...
                    //alert((((packets.length-packets.remaining)/packets.length)*100));
                    x.style.width=(((packets.length-packets.remaining)/packets.length)*100)+"%";
                };
