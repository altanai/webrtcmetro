...
<script type="text/javascript">
   ...
   // window.open("expert.htm");
    ...
    var txtInfo; 
	var request; //Session check

	
    //session management 
    function sessioncheck(){       
	    setInterval( function (){
	    xmlHttpRequest3.open("POST", "http://localhost:8080/TCSWebRTCSolution_Test/sessionServlet?sipuri="+login1.getPrivateIdentity, false);
	    xmlHttpRequest3.onreadystatechange=responsesessioncheck;
	    xmlHttpRequest3.send();  
	    },5000);
    }
  
    function responsesessioncheck(){
      
    	if(xmlHttpRequest3.readyState==4&&xmlHttpRequest3.status==200)
		{			
			alert(" result rom session check .... "+	xmlHttpRequest3.responseText);
		}
      }
...
<body oncontextmenu="return false" >
	...
	<div id="bodypat">
		<section id="container">
			...
			<section id="mainpage-mos">
				...
				<!-- <iframe width="1200px" height="800px" style="overflow: auto; overflow-y: hidden;" src="Interestsmarque"></iframe>
	...
	function updateStatusConference(data){bo
		 $.ajax({
			type:"POST",
			url:'NotificationServlet',
        ...
        <div class="span7 well">
            ...
            <table style='width: 100%'>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="width: 100%; height: 100%" id="txtWebsocketServerUrl" value="ws://10.1.5.15:443"  />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" style="width: 100%; height: 100%" id="txtSIPOutboundProxyUrl" value="tcp://10.1.5.15:5060"  />
                    </td>
                </tr>
                <tr>
                    <td>
