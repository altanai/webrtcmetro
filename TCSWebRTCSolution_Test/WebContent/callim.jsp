...
<!--                 <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div id="calldiv" style="width:50%; float:left;">
				 ...
				 <tr>
                    ...
                    <tr>
                       <td align='center'>
                          ...
                          <!-- placwe for advertisment div -->
            <div id="advdiv" style="width:50%; float:left;">
            <div id="divCallCtrl" class="well" style="display:table-cell; float:left;">
		                <h3>
		                 <left>  Adverisment Box</left>
		                </h3>
			</div>
            </div>
            ...
            <div id="divCallCtrl" class="well" style="display:table-cell; float:right;">
				...
				<tr><td width="50px"></td><td><div class="chatbox" id="sipMsgs" style="width: 258px;height: 104px;overflow: auto;border: 1px solid gray"></div></td></tr>		
