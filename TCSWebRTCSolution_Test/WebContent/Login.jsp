...
<body style="background-image:/DhirendraNath/WebContent/images/Background-5.jpg " onload="renderBtn(); noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
<div style="padding-bottom: 100px"></div>
	...
	<div id="top-bar">		
		...
		<p><img src="images/TCSLogo.jpg">&nbsp;&nbsp;Communication Client</p>
	</div> 
